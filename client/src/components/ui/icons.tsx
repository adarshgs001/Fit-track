...
export function RunIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M2 20h3a2 2 0 0 0 2-2v-6" />
      <path d="m11 8-3 6 5 .5-1 4.5" />
      <path d="M11 8v4" />
...
export function ProteinIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M8.4 10.6a2.1 2.1 0 1 1 0 4.2 2.1 2.1 0 0 1 0-4.2M18.9 10.6a2.1 2.1 0 1 1 0 4.2 2.1 2.1 0 0 1 0-4.2" />
      <path d="M2 12c0 3.56 2.31 6.67 6 8.4V19a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1.4c3.69-1.73 6-4.84 6-8.4 0-5.47-5-10-10-10S2 6.53 2 12Z" />
    </svg>
  );
}

export function CarbsIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M20 12v-2a8 8 0 0 0-8-8v2a6 6 0 0 1 6 6h2Z" />
      <path d="M18 12v-2a4 4 0 0 0-4-4v2a2 2 0 0 1 2 2h2Z" />
      <path d="M12 2v8" />
      <path d="M4.93 10.93a8 8 0 0 0 0 11.31" />
      <path d="M7.76 8.1a12 12 0 0 0 0 16.97" />
    </svg>
  );
}
